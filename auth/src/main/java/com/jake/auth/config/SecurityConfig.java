...
public class SecurityConfig {
    ...
    public SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http)
            throws Exception {
        http.csrf(csrf->csrf.ignoringRequestMatchers("/login", "/logout"))
                .authorizeHttpRequests((authorize) -> authorize.requestMatchers(HttpMethod.GET, "/static/**").permitAll())
                .formLogin(form -> form.loginPage("/index.html").loginProcessingUrl("/login")
